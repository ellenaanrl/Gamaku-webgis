...
class JalanController extends Controller
{
    ...
    {
        $data = DB::table('Jalan_Revisi')
            ->select('nama', 'material', 'pjg_jln_bu', 'lbr_jln_bu', 'jns_jln',  DB::raw('ST_AsGeoJSON(ST_Transform(geom, 4326)) as geojson'))
            ->get();
        ...
        $features = $data->map(function ($row) {
            return [
                ...
                'properties' => [
                    ...
                    'pjg_jln_bu' => $row->pjg_jln_bu,
                    'lbr_jln_bu' => $row->pjg_jln_bu,
                    'jns_jln' => $row->jns_jln,
                ]
            ];
        });
